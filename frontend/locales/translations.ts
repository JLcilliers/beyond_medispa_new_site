  ...
  facialDetails: {
    hydrafacialEdinburgh: {
      ...
      treatmentInfo: {
        ...
        price: 'From GBP 150 - Contact for personalized package pricing',
        benefits: [
    ...
    hydrafacialLondon: {
      ...
      treatmentInfo: {
        ...
        price: 'From GBP 150 - Contact for bespoke treatment packages',
        benefits: [
          'Deep pore cleansing',
          'Gentle exfoliation',
          'Painless extraction',
...
const en: Translations = {
  ...
  hero: {
    ...
    cqcRegulated: 'CQC & HIS Regulated For Patient Safety & Care',
  ...
  about: {
    ...
    pageSubtitle: 'Learn more about Beyond MediSpa',
    ...
    insideClinic: 'Inside ',
    insideClinicHighlight: 'Beyond MediSpa',
    gallery: 'GALLERY',
  ...
  faq: {
    title: 'Beyond Aesthetic Clinic |FAQs',
  ...
  contact: {
    ...
    primaryPhoneNumber: '020 7201 8595',
    secondaryPhoneNumber: '0345 548 1151',
