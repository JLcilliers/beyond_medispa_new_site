...
export default function ExilisPage() {
  useEffect(() => {
    ...
    if (metaDescription) {
      ...
      meta.content = "Transform your skin with Exilis Elite at Beyond Medispa. Non-invasive skin tightening and contouring for a firmer, youthful look without surgery.";
