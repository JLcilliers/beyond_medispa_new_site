      ...
      <div className="pt-20">
        <section className="relative min-h-screen bg-gradient-to-br from-[#111A19] to-[#284139] text-white overflow-hidden">
          <div className="absolute inset-0">
            <img src="/api/placeholder/1920/1080" alt="Nasolabial lines treatment" className="w-full h-full object-cover opacity-60" />
          ...
          <div className="relative container mx-auto px-4 py-32 flex items-center min-h-screen">
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl lg:text-7xl font-light leading-tight mb-8">
                ...
                Smooth Lines and<br />
                <span className="text-[#F8D794]">Youthful Contours</span>
              </h1>
              <Button 
        ...
        <section className="py-24 bg-[#80907E] text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-light mb-8">Indulge in Line Smoothing</h2>
            <p className="text-xl leading-relaxed max-w-4xl mx-auto opacity-90">
              Step into a realm of refined beauty, where nasolabial lines are expertly smoothed for a more youthful appearance. 
              At MagiSpa, our specialized treatments restore natural facial harmony.
            </p>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-12">
                <div className="text-center bg-[#F8D794]/10 rounded-2xl p-6">
                  ...
                  <p className="text-gray-600 text-sm">Precise treatment</p>
                </div>
              ...
              <div className="text-center">
                ...
                >
                  BOOK NASOLABIAL LINES TREATMENT
                </Button>
              </div>
            </div>
          </div>
