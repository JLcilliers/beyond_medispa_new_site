      ...
      <div className="pt-20">
          ...
          <div className="relative container mx-auto px-4 py-32 flex items-center min-h-screen">
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl lg:text-7xl font-light leading-tight mb-8">
                ...
                Pure Oxygen and<br />
                <span className="text-[#F8D794]">Radiant Glow</span>
              </h1>
              <Button 
        ...
        <section className="py-24 bg-[#80907E] text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-light mb-8">Indulge in Oxygenated Beauty</h2>
            <p className="text-xl leading-relaxed max-w-4xl mx-auto opacity-90">
              Step into a realm of pure refreshment, where pressurized oxygen revitalizes your skin from within. 
              At MagiSpa, our oxygen facial delivers an instant boost of radiance and hydration for glowing skin.
            </p>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-12">
                <div className="text-center bg-[#F8D794]/10 rounded-2xl p-6">
                  ...
                  <p className="text-2xl font-light text-[#284139] mb-2">60 minutes</p>
                ...
                <div className="text-center bg-[#F8D794]/10 rounded-2xl p-6">
                  ...
                  <p className="text-gray-600 text-sm">Instant glow</p>
                </div>
