      ...
      <div className="pt-20">
        ...
        <section className="relative min-h-screen bg-gradient-to-br from-[#111A19] to-[#284139] text-white overflow-hidden">
          <div className="absolute inset-0">
            <img 
              ...
              alt="Cheek enhancement treatment"
          ...
          <div className="relative container mx-auto px-4 py-32 flex items-center min-h-screen">
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl lg:text-7xl font-light leading-tight mb-8">
                ...
                Sculpted Cheeks and<br />
                <span className="text-[#F8D794]">Refined Contours</span>
              </h1>
              <Button 
        ...
        <section className="py-24 bg-[#80907E] text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-light mb-8">Indulge in Sculpted Elegance</h2>
            <p className="text-xl leading-relaxed max-w-4xl mx-auto opacity-90">
              Step into a realm of refined beauty, where expertly placed dermal fillers create stunning cheek definition and volume. 
              At MagiSpa, our cheek enhancement treatments restore youthful contours with artistic precision.
            </p>
          </div>
        </section>
