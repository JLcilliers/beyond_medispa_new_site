        ...
        <section className="relative min-h-screen bg-gradient-to-br from-[#111A19] to-[#284139] text-white overflow-hidden">
          <div className="absolute inset-0">
            <img 
              ...
              alt="Microneedling skin rejuvenation"
          ...
          <div className="relative container mx-auto px-4 py-32 flex items-center min-h-screen">
            <div className="max-w-2xl">
              <p className="text-[#F8D794] text-lg mb-4 tracking-wider">SKIN REJUVENATION</p>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-lg">
                Advanced microneedling treatments to stimulate collagen production 
                and improve skin texture, tone, and overall appearance.
              </p>
              <Button 
