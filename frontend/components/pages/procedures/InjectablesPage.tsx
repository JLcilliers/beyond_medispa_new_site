        ...
        <section className="relative min-h-screen bg-gradient-to-br from-[#111A19] to-[#284139] text-white overflow-hidden">
          <div className="absolute inset-0">
            <img 
              ...
              alt="Injectable treatments at spa"
          ...
          <div className="relative container mx-auto px-4 py-32 flex items-center min-h-screen">
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl lg:text-7xl font-light leading-tight mb-8">
                ...
                Enhancement and<br />
                <span className="text-[#F8D794]">Rejuvenation</span>
              </h1>
              <Button 
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                { name: "Facial Balancing", price: "From £500", route: "facial-balancing" },
                { name: "Profhilo", price: "From £450", route: "profhilo" },
                { name: "Nucleofill", price: "From £350", route: "nucleofill" },
                { name: "Fat Dissolving Injectables", price: "From £400", route: "fat-dissolving-injectables" },
