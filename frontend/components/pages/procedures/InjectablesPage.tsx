  ...
  const customSections = (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-light text-[#2C2C2C] mb-8">
                Your Oasis of<br />
                <span className="text-[#A38E78]">Enhancement</span>
              </h2>
              
              <div className="space-y-8">
                <div className="flex items-start space-x-6">
                  <div className="bg-[#F5F1EC] p-4 rounded-full">
                    <Leaf className="w-8 h-8 text-[#A38E78]" />
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold text-[#2C2C2C] mb-3">Nurturing Atmosphere</h3>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#2C2C2C] mb-3">Skilled Practitioners</h3>
                    <p className="text-[#333333] leading-relaxed">
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#2C2C2C] mb-3">Tailored Treatments</h3>
                    <p className="text-[#333333] leading-relaxed">
      ...
      <section className="py-24 bg-[#F5F1EC]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-light text-[#2C2C2C] mb-8">Revitalize Your Senses</h2>
          ...
          <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto">
            ...
            <div className="text-left">
              ...
              <h3 className="text-2xl font-light text-[#2C2C2C] mb-6">Injectable Treatments</h3>
            ...
            <div className="text-left">
              ...
              <h3 className="text-2xl font-light text-[#2C2C2C] mb-6">Enhancement Therapy</h3>
              <p className="text-[#333333] leading-relaxed mb-6">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[#2C2C2C] mb-4">Injectable Treatments Menu</h2>
