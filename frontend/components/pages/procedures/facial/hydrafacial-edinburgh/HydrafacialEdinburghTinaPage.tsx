...
import HydrafacialEdinburghContent from "./HydrafacialEdinburghContent";
import { SEOHead } from "../../../../SEO/SEOHead";

export default function HydrafacialEdinburghTinaPage() {
    ...
    const fetchContent = async () => {
      try {
        const result = await client.queries.treatment({
          relativePath: "hydrafacial-edinburgh.json",
        });
  ...
  return (
    <>
      <SEOHead
        ...
        pagePath="/procedures/facial/hydrafacial-edinburgh"
        treatmentCategory={treatmentData.category}
        location={treatmentData.location}
      />
      <HydrafacialEdinburghContent data={graphQLResponse} />
    </>
  );
}
