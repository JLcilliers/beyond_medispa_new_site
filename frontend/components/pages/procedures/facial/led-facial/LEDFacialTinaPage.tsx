...
import LEDFacialContent from "./LEDFacialContent";
import { SEOHead } from "../../../../SEO/SEOHead";

export default function LEDFacialTinaPage() {
  ...
  return (
    <>
      <SEOHead
        ...
        pagePath="/procedures/facial/led-facial"
        treatmentCategory={treatmentData.category}
        location={treatmentData.location}
      />
      <LEDFacialContent data={graphQLResponse} />
    </>
  );
}
