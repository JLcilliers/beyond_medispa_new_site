...
import HydrafacialLondonContent from "./HydrafacialLondonContent";
import { SEOHead } from "../../../../SEO/SEOHead";

export default function HydrafacialLondonTinaPage() {
    ...
    const fetchContent = async () => {
      try {
        const result = await client.queries.treatment({
          relativePath: "hydrafacial-london.json",
        });
  ...
  return (
    <>
      <SEOHead
        ...
        pagePath="/procedures/facial/hydrafacial-london"
        treatmentCategory={treatmentData.category}
        location={treatmentData.location}
      />
      <HydrafacialLondonContent data={graphQLResponse} />
    </>
  );
}
