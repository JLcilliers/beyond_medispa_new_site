...
import ProfhiloContent from "./ProfhiloContent";
import { SEOHead } from "../../../SEO/SEOHead";

export default function ProfhiloTinaPage() {
  ...
  return (
    <>
      <SEOHead
        ...
        pagePath="/procedures/injectables/profhilo"
        treatmentCategory={treatmentData.category}
        location={treatmentData.location}
      />
      <ProfhiloContent data={graphQLResponse} />
    </>
  );
}
