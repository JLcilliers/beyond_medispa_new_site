...
import PolynucleotidesContent from "./PolynucleotidesContent";
import { SEOHead } from "../../../SEO/SEOHead";

export default function PolynucleotidesTinaPage() {
    ...
    const fetchContent = async () => {
      try {
        const result = await client.queries.treatment({
          relativePath: "polynucleotides.json",
        });
  ...
  return (
    <>
      <SEOHead
        ...
        pagePath="/procedures/injectables/polynucleotides"
        treatmentCategory={treatmentData.category}
        location={treatmentData.location}
      />
      <PolynucleotidesContent data={graphQLResponse} />
    </>
  );
}
