          ...
          <div className="relative container mx-auto px-4 py-32 flex items-center min-h-screen">
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl lg:text-7xl font-light leading-tight mb-8">
                ...
                Radiant Skin and<br />
                <span className="text-[#F8D794]">Renewal</span>
              </h1>
              <Button 
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                { name: "Hydratite Facial", price: "From £120", route: "hydratite-facial" },
                { name: "Oxygen Facial", price: "From £100", route: "oxygen-facial" },
                { name: "Hydro Peptide", price: "From £130", route: "hydro-peptide" },
                ...
                { name: "PRP for Hair Growth", price: "From £400", route: "prp-hair-growth" },
                { name: "Exosomes / DEC Exosomes", price: "From £500", route: "exosomes-dec" },
                { name: "ZO Facial by Zein Obagi", price: "From £200", route: "zo-facial-zein-obagi" },
                { name: "Obagi Blue Radiance Peel", price: "From £180", route: "obagi-blue-radiance-peel" },
                { name: "Exilis Elite Facial Skin Tightening", price: "From £300", route: "exilis-elite-facial" },
                { name: "Cool Laser", price: "From £350", route: "cool-laser" },
                { name: "Elos IPL Skin Rejuvenation", price: "From £250", route: "elos-ipl-skin-rejuvenation" }
              ].map((treatment, index) => (
