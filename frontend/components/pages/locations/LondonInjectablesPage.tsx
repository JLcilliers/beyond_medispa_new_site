...
export default function LondonInjectablesPage() {
  const hero = {
    ...
    description:
      'Professional injectable treatments for aesthetic enhancement, wellness, and therapeutic benefits delivered by experienced practitioners at our London location.'
  }
