...
```bash
git remote add encore encore://html-landing-page-88bi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/html-landing-page-88bi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/html-landing-page-88bi/settings/integrations/github)
